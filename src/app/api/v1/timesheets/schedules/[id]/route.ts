...
export const GET = (request: NextRequest, { params }: Params<"id">) =>
  wrapper(
    ...
    async ({ params }) => {
      if (!params) {
        throw new Errors.BadRequest("Shift ID is required");
      }
  ...
  wrapper(
    {
      ...
      params,
      parser: z.union([updateScheduleSchema, approveShiftSchema]),
    },
    async ({ params, body, auth }) => {
      ...
      // Otherwise, treat as schedule update (body is UpdateScheduleSchema)
